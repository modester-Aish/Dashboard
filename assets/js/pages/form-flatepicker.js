  ...
  init() {
    document.getElementById("basic-datepicker").flatpickr(),
      ...
      document
        ...
        .flatpickr({ altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d" }),
      document
      ...
      document.getElementById("range-datepicker").flatpickr({ mode: "range" }),
      document.getElementById("inline-datepicker").flatpickr({ inline: !0 }),
      document
        .getElementById("basic-timepicker")
        .flatpickr({ enableTime: !0, noCalendar: !0, dateFormat: "H:i" }),
      document
